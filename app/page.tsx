    ...
    <div className="overflow-hidden bg-slate-50">
      ...
      <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 text-white py-20 md:py-28 px-4 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(#4fd1c5 1px, transparent 1px)",
        ...
        <div className="px-2 md:px-4 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center divide-x divide-slate-100">
          {[
            ...
            >
              ...
              <p className="text-slate-500 font-bold uppercase tracking-wider text-[10px] sm:text-xs md:text-sm mt-2 md:mt-3">
                {stat.label}
              </p>
            </motion.div>
          ))}
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 md:gap-12 items-center">
          ...
          >
            ...
            <div className="flex justify-center md:justify-start">
              <Link
                href="/about"
                className="text-cyan-600 font-bold text-base md:text-lg hover:text-cyan-700 flex items-center gap-2 transition"
              >
      ...
      <section
        id="services"
        className="py-16 md:py-24 px-4 bg-slate-900 text-white relative"
      >
            ...
            {coreCompetencies.map((comp, index) => (
              ...
              >
                <TiltCard className="bg-slate-800/50 p-6 md:p-8 rounded-2xl border border-slate-700 h-full cursor-pointer hover:bg-slate-800 transition-colors flex flex-col">
                  ...
                  <h4 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4 tracking-tight leading-tight">
                    {comp.name}
                  </h4>
...
<section className="py-16 border-b border-slate-100">
  <div className="max-w-5xl mx-auto px-4 text-center">
    ...
    {/* Heading */}
    <h3 className="text-3xl sm:text-4xl font-extrabold text-blue-950 mb-3">
    ...
    {/* Rounded Container */}
    <div className="flex items-center justify-center bg-slate-50 rounded-full px-10 py-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
            {industriesServed.map((industry, index) => (
              ...
              >
                ...
                <h4 className="font-bold text-slate-800 text-xs sm:text-sm text-center">
                  {industry.name}
                </h4>
              </motion.div>
            ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
            <motion.div
              ...
              custom={1}
            >
              <h3 className="text-3xl md:text-4xl font-extrabold text-blue-950 mb-6 text-center lg:text-left">
                Why Partner With Us?
              </h3>
            ...
            >
              <div className="relative max-w-md mx-auto lg:max-w-full">
                ...
                <div className="bg-blue-950 rounded-3xl p-6 sm:p-8 md:p-10 relative text-white shadow-2xl">
                  <h4 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-cyan-400 text-center sm:text-left">
                  ...
                  <div className="bg-slate-800/50 p-4 sm:p-6 rounded-xl border border-slate-700 text-center sm:text-left">
                    <p className="text-xs sm:text-sm text-slate-400 uppercase font-bold tracking-wider mb-2">
                      Direct Contact
                    </p>
                    <p className="text-lg sm:text-xl font-bold mb-1">
                      +91 9881442416
                    </p>
                    <p className="text-cyan-400 text-sm sm:text-base break-words">
